                    ...
                    return ListTile(
                      leading:
                          allNotificationModel.results![index].isRead == true
                              ? const FaIcon(FontAwesomeIcons.solidEnvelopeOpen,color: Colors.green,)
                              : const FaIcon(
                                  FontAwesomeIcons.solidEnvelope,color: Colors.red,
                                ),
                      title: Text(
                          allNotificationModel.results![index].msg.toString()),
                      subtitle:  Text(allNotificationModel.results![index].createdDateAd.toString()),
